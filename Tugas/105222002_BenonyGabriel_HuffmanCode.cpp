...
Tugas Praktikum - Huffman Code

Buat sub program untuk membuat huffman tree dan mengembalikan huffman code berdasarkan frekuensi tiap huruf yang diterima sebagai input dalam bentuk array
*/
...
MinHeapNode* newNode(char data, unsigned freq) {
    return new MinHeapNode(data, freq);
}
